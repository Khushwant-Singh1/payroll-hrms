      ...
      <nav className="flex-1 p-4 space-y-1.5">
        {menuItems.map(({ id, label, icon: Icon }) => (
          <button
            ...
            className={`w-full flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} px-3 py-2 rounded-md text-sm font-medium transition-colors
              ${activeTab === id
        ...
        <button
          ...
          className={`w-full flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-3'} px-3 py-2 rounded-md text-sm font-medium transition-colors text-gray-700 hover:bg-gray-100 border-t pt-3 mt-3`}
