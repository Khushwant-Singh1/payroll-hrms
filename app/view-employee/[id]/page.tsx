...
import { ArrowLeft, Edit, User, Calendar, Phone, Mail, Building, MapPin, IndianRupee, CreditCard, FileText } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <Button 
            variant="ghost" 
            onClick={() => router.push("/?tab=hr-data")}
            className="mb-4"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Dashboard
          ...
          <div className="flex items-center justify-between">
            ...
            <Button 
              onClick={() => router.push(`/edit-employee/${employeeId}`)}
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 mb-3">{employee.department} • {employee.company}</p>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{employee.dateOfBirth ? formatDate(employee.dateOfBirth) : "Not provided"}</p>
                </div>
